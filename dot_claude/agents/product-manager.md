...
description: >-
  ...
  workflow: gathers requirements, reads the codebase, proposes an approach, delegates
  to the Software Engineer, Changelog Tester, Regression Tester, and Security Auditor,
  resolves conflicts, and hands off to docs-writer for documentation and PR creation.
